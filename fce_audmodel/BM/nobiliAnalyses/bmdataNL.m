...
save('bmdataNL.mat', 'x', 'N', 'M', 'stiff', 'dampn', 'damp0', 'ShSp', 'G', 'Gs', 'bmw');
bmdataNL = struct('x', x, 'N', N, 'M', M, 'stiff', stiff, 'dampn', dampn, ...
                  'damp0', damp0, 'ShSp', ShSp, 'G', G, 'Gs', Gs, 'bmw', bmw);
